...
namespace ShooppyMegaMall.Infrastructure.Data
{
    public partial class ShooppyMegaMall_masterContext : DbContext
    {
        public ShooppyMegaMall_masterContext()
        {
        }

        public ShooppyMegaMall_masterContext(DbContextOptions<ShooppyMegaMall_masterContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=103.150.186.216;Initial Catalog=ShooppyMegaMall_master;User ID=sa;Password=Z8Lix[jg3K@R74;MultipleActiveResultSets=True;Application Name=EntityFramework");
                //optionsBuilder.UseSqlServer("Data Source=DESKTOP-40G3LDG;Initial Catalog=ShooppyMegaMall_master;MultipleActiveResultSets=True;Application Name=EntityFramework");
            }
        }
