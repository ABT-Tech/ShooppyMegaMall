...
using ShooppyMegaMall.Core.ValueObjects;
...
namespace ShooppyMegaMall.Infrastructure.Repository
{
    public class AuthenticatiosRepository : IAuthenticationsRepository
    {
        ...
        protected readonly ShooppyMegaMall_masterContext _MasterContext;
        public AuthenticatiosRepository(ShooppyMegaMall_masterContext dbContext)
        {
