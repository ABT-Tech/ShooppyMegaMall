...
namespace ShooppyMegaMall.Application.Mapper
{
    ...
    public static class ObjectMapper
    {
        private static readonly Lazy<IMapper> Lazy = new Lazy<IMapper>(() =>
        {
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.AddProfile<ShooppyMegaMallDtoMapper>();
            });
    ...
    public class ShooppyMegaMallDtoMapper : AutoMapper.Profile
    {
        public ShooppyMegaMallDtoMapper()
        {
